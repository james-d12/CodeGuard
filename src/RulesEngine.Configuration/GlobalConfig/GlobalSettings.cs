...
/// rule source configured by `rules-engine setup`, used as a last-resort fallback by
/// <c>CliRepositoryContext</c> when a target repo has no `.rulesengine/config.yml` of its own.
/// </summary>
