...
namespace RulesEngine.Configuration.Tests.GlobalConfig;
...
public class GlobalSettingsPathsTests
{
    ...
    public void ResolveRoot_UsesAppDataOnWindows()
    {
        ...
        Assert.Equal(Path.Combine(@"C:\Users\jamie\AppData\Roaming", "RulesEngine"), root);
    }
    ...
    public void ResolveRoot_UsesNativeLibraryPathOnMacOs()
    {
        ...
        Assert.Equal(Path.Combine("/Users/jamie", "Library", "Application Support", "RulesEngine"), root);
    }
    ...
    public void ResolveRoot_UsesXdgConfigHomeOnLinux_WhenSet()
    {
        ...
        Assert.Equal(Path.Combine("/home/jamie/.xdgconfig", "rules-engine"), root);
    }
    ...
    public void ResolveRoot_FallsBackToDotConfigOnLinux_WhenXdgConfigHomeUnset()
    {
        ...
        Assert.Equal(Path.Combine("/home/jamie", ".config", "rules-engine"), root);
    }
